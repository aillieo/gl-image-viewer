...
int lightWithoutHDR(GLFWwindow* window)
{
	...
	Shader* shader = new Shader("HighDynamicRange/shader1.vsh","HighDynamicRange/shader1.fsh");
	Shader* shaderScreen= new Shader("HighDynamicRange/shader2.vsh","HighDynamicRange/shader2.fsh");
	...
	unsigned int diffuseTexture = TextureLoader::loadTexture("wood.png");
...
int HDRWithReinhard(GLFWwindow* window)
{
	...
	Shader* shader = new Shader("HighDynamicRange/shader1.vsh","HighDynamicRange/shader1.fsh");
	Shader* shaderScreen= new Shader("HighDynamicRange/shader3.vsh","HighDynamicRange/shader3.fsh");
...
int HDRWithHighExposure(GLFWwindow* window)
{
	...
	Shader* shader = new Shader("HighDynamicRange/shader1.vsh","HighDynamicRange/shader1.fsh");
	Shader* shaderScreen= new Shader("HighDynamicRange/shader4.vsh","HighDynamicRange/shader4.fsh");
...
int HDRWithLowExposure(GLFWwindow* window)
{
	...
	Shader* shader = new Shader("HighDynamicRange/shader1.vsh","HighDynamicRange/shader1.fsh");
	Shader* shaderScreen= new Shader("HighDynamicRange/shader5.vsh","HighDynamicRange/shader5.fsh");
	...
	while(!glfwWindowShouldClose(window) && !SceneManager::willChangeScene)
	{
		...
		shaderScreen->use();
		shaderScreen->setFloat("exposure", 0.1f);
		glBindVertexArray(VAO[1]);
		glBindTexture(GL_TEXTURE_2D, textureColorbuffer);	// use the color attachment texture as the texture of the quad plane
		glDrawArrays(GL_TRIANGLES, 0, 6);
