...
int postProcessings(GLFWwindow* window)
{
	...
	Shader* shader = new Shader("FrameBuffers/shader1.vsh","FrameBuffers/shader1.fsh");
	Shader* shaderScreen = new Shader[4];
	shaderScreen[0].init("FrameBuffers/shader3.vsh","FrameBuffers/shader3.fsh");
	shaderScreen[1].init("FrameBuffers/shader4.vsh","FrameBuffers/shader4.fsh");
	shaderScreen[2].init("FrameBuffers/shader5.vsh","FrameBuffers/shader5.fsh");
	shaderScreen[3].init("FrameBuffers/shader6.vsh","FrameBuffers/shader6.fsh");
	...
	// bind VAO VBO
	unsigned int VBO[2], VAO[2], VBOscreen[4], VAOscreen[4];
